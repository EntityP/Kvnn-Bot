...
module.exports = {
     ...
     */
     ...
     run: async (client, interaction, args) => {
         ...
         if(!target) return interaction.reply({ content: 'Please Ping A User' });
         if(!reason) return interaction.reply({ content: 'Please Give A Reason' })
         ...
         if(!interaction.member.permissions.has("BAN_MEMBERS")) {
           ...
           target.ban({ target });
            ...
            interaction.reply({ embeds: [banmsg] });
     },
};